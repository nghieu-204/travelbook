...
exports.confirmOnlinePayment = async (req, res) => {
    try {
        ...
        // Thay vì chỉ báo 'Đã thanh toán Online', set trạng thái là 'Đã xác nhận' 
        // để admin không cần duyệt lại, hệ thống ghi nhận thành công luôn.
        const statusLabel = 'Đã xác nhận';
